...
public class TestPerson {
    ...
    public void calculateNetSalaryOfBelgianPersonUsingMockCompany() throws SalaryTooLowException {
        //arrange
        personUnderTest = new Person(1, "Sonja", "De Meersman", LocalDate.of(1977, 12, 21),companyUnderTest, 3500);
        when(companyUnderTest.calculateTaxToPay()).thenReturn(51.0);
        //act
        double netSalary = personUnderTest.calculateNetSalary();
        //assert
        verify(companyUnderTest).calculateTaxToPay();
    }

    @Test(expected = SalaryTooLowException.class)
    public void salaryTooLowException() throws SalaryTooLowException{
        //arrange
        personUnderTest = new Person(1, "Sonja", "De Meersman", LocalDate.of(1977, 12, 21),companyUnderTest, 2000);
        when(companyUnderTest.calculateTaxToPay()).thenReturn(51.0);
        //act
